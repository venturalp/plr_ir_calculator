...
module.exports = () => {
  ...
  return {
    module: {
      rules: [
        {
          test: /\.(ts|js)x?$/, // regex to find files that webpack applies
          resolve: {
            extensions: ['.js', '.jsx', '.ts', '.tsx'], // resolves files extensiosn
          },
    ...
    optimization: {
      ...
      minimizer: environment === 'prd' ? [new TerserPlugin()] : [],
    },
    entry: './src/index.tsx', // main file to generates the bundle
    output: {
      // output settings
